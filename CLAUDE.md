...
## Current status
Block 2 (Data layer) complete — see HANDOVER_BLOCK_2.md. Update this section at the end of every block with: which block just completed, and a one-line pointer to that block's Handover Doc location.
